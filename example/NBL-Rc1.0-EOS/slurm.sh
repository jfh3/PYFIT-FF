...
#SBATCH -D /wrk/jfh3/2020-01-22-PYFIT-TEST/NBL-Rc1.0-EOS  #set working directory of batch script before execution

cd /wrk/jfh3/2020-01-22-PYFIT-TEST/NBL-Rc1.0-EOS  
