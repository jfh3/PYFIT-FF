...
NETWORK_BACKUP_DIR                 = 'output/run_1.0_weight_nz/nn_backup/'
...
LOSS_LOG_PATH                      = 'output/run_1.0_weight_nz/loss_log.txt'

# The file to log the validation loss in.
VALIDATION_LOG_PATH                = 'output/run_1.0_weight_nz/validation_loss_log.txt'
...
GROUP_ERROR_FILE = 'output/run_1.0_weight_nz/group_error.txt'
