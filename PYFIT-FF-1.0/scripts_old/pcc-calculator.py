...
if __name__ == '__main__':
	log_file          = 'pcc_calc_output/pcc-calc-log.txt'
	training_set_file = '../input/AB/AB-LSPARAM-E-full-NO-B00-B01-B02-10-r0-sigma-0.25.dat'
	results_file      = 'pcc_calc_output/results-10-r0-sigma-0.25.json'

	Util.init(log_file)
	Util.set_mode(unsupervised=False)
