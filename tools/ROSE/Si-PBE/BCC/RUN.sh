...
name="BCC-ROSE"	#group name
r1=2.0    	#relation between V/N and lattice constant --> a^3=r1*v   
r2=0.8660254    #relation between nearest neighbor dist and lattice constant --> rnn=r2*a
