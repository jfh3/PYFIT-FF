...
Na=4		#number of atoms in cubic cell 
name="FCC-ROSE"	#group name
r1=4.0    	#relation between V/N and lattice constant --> a^3=r1*v   
r2=0.70710678    #relation between nearest neighbor dist and lattice constant --> rnn=r2*a
